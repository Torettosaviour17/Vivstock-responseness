...
function TraderCard({ trader }) {
  ...
  return (
    <div className=" w-[320px] bg-transparent md:h-[280px] relative   min-h-[100px] border border-[#626060] rounded-[20px] sm:p-5  md:p-6 min-w-[250px] md:min-w-[calc(50%-1rem)]">
